...
class Scene(scene.Scene):
    ...
    def notify_handler(self, data):
        ...
        self.bot.front_right_leg.pos = data.front_right_leg.pos

        pos = self.bot.front_right_leg.p_1.pos
        pos[2] = data.front_right_leg.shoulder_offset
        self.bot.front_right_leg.p_1.pos = pos
        pos = self.bot.front_right_leg.p_2.pos
        pos[2] = data.front_right_leg.shoulder_lenght
        ...
        self.bot.front_left_leg.pos = data.front_left_leg.pos

        pos = self.bot.front_left_leg.p_1.pos
        pos[2] = data.front_left_leg.shoulder_offset
        self.bot.front_left_leg.p_1.pos = pos
        pos = self.bot.front_left_leg.p_2.pos
        pos[2] = data.front_left_leg.shoulder_lenght
        ...
        self.bot.rear_right_leg.pos = data.rear_right_leg.pos

        pos = self.bot.rear_right_leg.p_1.pos
        pos[2] = data.rear_right_leg.shoulder_offset
        self.bot.rear_right_leg.p_1.pos = pos
        pos = self.bot.rear_right_leg.p_2.pos
        pos[2] = data.rear_right_leg.shoulder_lenght
        ...
        self.bot.rear_left_leg.pos = data.rear_left_leg.pos

        pos = self.bot.rear_left_leg.p_1.pos
        pos[2] = data.rear_left_leg.shoulder_offset
        self.bot.rear_left_leg.p_1.pos = pos

        pos = self.bot.rear_left_leg.p_2.pos
        pos[2] = data.rear_left_leg.shoulder_lenght
